...
[`experiments/LEARNINGS.md`](experiments/LEARNINGS.md) findings 20-30 and the grounded
...
| Leading-path spine, findings 20-30 (geometry gap map, Max-IP log-shave attack, J1 transfer, fused-max-MM build, first-principles wall-hardening, adaptive-wall closure, TC0-PRF natural-proofs collision, four-joint descent-to-NP map) | Run to completion, verifier-checked; precise coordinates, no progress on the prize |
